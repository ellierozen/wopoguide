...
<!-- Card 3 -->
    <div class="card">
        ...
        <div class="container">
            <center><h4><b>Learn more about the different players and their stats!</b></h4></center>
            <center><button class="button" onclick="location.href='//ellierozen.github.io/wopoguide/stats';">Search</button></center>
        </div>
    </div>
<!-- Gif -->
